<div id="footer">
	...
	<p>The Linked Jazz logo was designed by <a href="http://www.enricocorte.net">Enrico Corte</a>. | <a href="<?php echo home_url( '/' ); ?>" title="<?php bloginfo ('name');?>"><?php bloginfo ('name');?></a> <?php _e('powered by','jenny'); ?> <a href="http://www.wordpress.org"><?php _e('WordPress','jenny'); ?></a> and <a href="http://www.speckygeek.com/wordpress-themes/" title="Free WordPress theme"><?php _e('Jenny','jenny'); ?></a>. </p>
	</div>
	<div class="right">
